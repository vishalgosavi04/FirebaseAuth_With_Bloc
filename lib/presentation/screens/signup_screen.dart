                    ...
                    child: BlocConsumer<FirebaseAuthCubit, FirebaseAuthState>(
                      ...
                      builder: (context, state) {
                        return ElevatedButton(
                          onPressed: () {
                            state is FirebaseAuthLoading
                              ? null
                              : context.read<FirebaseAuthCubit>().FirebaseSignup(_emailcontroller.text, _passwordcontroller.text);
                          },
                          child: const Text(
                            "Sign up",
                      ...
                      return TextButton(
                        onPressed: () {
                          state is AuthGoogleloading
                              ? null
                              : context.read<AuthGoogleCubit>().GoogleLogin();
                        },
                        child: Row(
